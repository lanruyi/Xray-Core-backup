...
type Config struct {
	...
	PortTos map[string]uint32 `protobuf:"bytes,3,rep,name=port_tos,json=portTos,proto3" json:"port_tos,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
...
func (x *Config) GetPortTos() map[string]uint32 {
	if x != nil {
		return x.PortTos
	}
	return nil
...
var file_proxy_dokodemo_config_proto_rawDesc = []byte{
	...
	0x70, 0x6f, 0x72, 0x74, 0x5f, 0x74, 0x6f, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x28,
	...
	0x54, 0x6f, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x07, 0x70, 0x6f, 0x72, 0x74, 0x54, 0x6f,
	0x73, 0x12, 0x34, 0x0a, 0x08, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x73, 0x18, 0x07, 0x20,
	...
	0x3a, 0x0a, 0x0c, 0x50, 0x6f, 0x72, 0x74, 0x54, 0x6f, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12,
...
var file_proxy_dokodemo_config_proto_goTypes = []any{
	...
	nil,                    // 1: xray.proxy.dokodemo.Config.PortTosEntry
...
var file_proxy_dokodemo_config_proto_depIdxs = []int32{
	...
	1, // 1: xray.proxy.dokodemo.Config.port_tos:type_name -> xray.proxy.dokodemo.Config.PortTosEntry
